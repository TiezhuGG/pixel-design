...
export async function generateAestheticMirrorImage(params: {
  ...
  const modelConfig =
    (runtimeId ? await getEffectiveModelConfig(runtimeId, params.merchantId) : null) ||
    (models.imageModel?.runtimeId ? await getEffectiveModelConfig(models.imageModel.runtimeId, params.merchantId) : null)
