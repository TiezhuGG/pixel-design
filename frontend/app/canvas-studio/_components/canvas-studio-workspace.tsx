  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-white">
      ...
      <div className="relative flex min-h-0 flex-1 overflow-hidden">
        <Link
          href="/studio-genesis"
          className="absolute left-4 top-4 z-40 flex h-9 items-center gap-2 rounded-full border border-zinc-200 bg-white/95 px-3 text-xs font-medium text-zinc-700 shadow-sm backdrop-blur transition-colors hover:bg-zinc-50 hover:text-zinc-950"
          aria-label="返回产品页"
        >
        ...
        >
          ...
          {notice ? (
            <div className="pointer-events-none absolute left-4 top-16 z-20 rounded-md bg-white/95 px-3 py-2 text-xs font-medium text-zinc-600 shadow-sm">
              {notice}
            </div>
          ) : null}
        </div>
