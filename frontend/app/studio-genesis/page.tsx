...
const WHY_PIXELDESIGN = [
  {
    title: "请设计师太贵？",
    description: "一个人顶一个设计部，PixelDesign 把设计成本降至近乎为零。",
  },
  {
    title: "外包沟通太累？",
...
const FAQ_ITEMS = [
  {
    question: "通过 PixelDesign 生成的图片，版权归谁所有？",
    answer:
      "归你所有。你拥有 PixelDesign 生成的所有图片的 100% 所有权。你可以自由地将这些图片用于任何平台的商业用途，无需署名或额外授权。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "完全不需要。PixelDesign 专为非设计人员打造。只要你能用手机拍出一张清晰的产品原图，剩下的复杂打光、抠图去背和美化排版，AI 都能为你一键搞定。",
  },
  {
  ...
  {
    question: "相比聘请美工或设计外包，PixelDesign 有什么优势？",
    answer:
      "极致的效率与成本。传统外包可能需要数天交付，而 PixelDesign 仅需几秒即可生成数十种摄影棚级的设计方案，且成本几乎可以忽略不计。这能帮你大幅提升测款速度，随时调整营销策略。",
  },
  {
    question: "PixelDesign 的目标用户群体是谁？",
    answer:
      "PixelDesign 专为小型电商团队和独立卖家量身打造。我们通过 AI 技术赋能，帮助你在无需聘请专职设计团队或支付昂贵外包费用的前提下，也能获得行业顶尖的视觉设计水准。",
  },
] as const
    ...
    <ProductDetailShell>
      ...
      {/* <section className="py-20 px-4 sm:px-6 bg-background">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground mb-4">为什么选择 PixelDesign?</h2>
            <p className="text-muted-foreground text-lg">
              让小团队也有大牌设计力。支持智能全品类商品图和风格复刻，让您的商品脱颖而出。
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {WHY_PIXELDESIGN.map((item) => (
      ...
      {/* <section className="py-20 px-4 sm:px-6 bg-muted/30" id="faq">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">了解 PixelDesign 如何助力您的电商业务</p>
          </div>
